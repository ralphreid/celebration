	...
	*/
	...
	$sections[] = array(
		...
		'fields' => array(
	        ...
	        array(
				'id'=>'blog-template',
				'type' => 'select',
				'title' => __('Blog template', 'redux-framework-demo'), 
				'subtitle' => __('Select template for blog', 'redux-framework-demo'),
				'desc' => __('You can choose, wheather to display sidebar or not.', 'redux-framework-demo'),
				'options' => array('left_sidebar' => 'Left sidebar','right_sidebar' => 'Right sidebar','full_width' => 'Full width'),
	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				...
				'subtitle' => __('Select main color of the theme', 'redux-framework-demo'),
				'options' => array(
						'color-1' => array('alt' => 'Color 1', 'img' => $patterns_path.'color-1.png'),
						'color-2' => array('alt' => 'Color 2', 'img' => $patterns_path.'color-2.png'),
						'color-3' => array('alt' => 'Color 3', 'img' => $patterns_path.'color-3.png'),
						'color-4' => array('alt' => 'Color 4', 'img' => $patterns_path.'color-4.png'),
						'color-5' => array('alt' => 'Color 5', 'img' => $patterns_path.'color-5.png'),
						'color-6' => array('alt' => 'Color 6', 'img' => $patterns_path.'color-6.png'),
						'color-7' => array('alt' => 'Color 7', 'img' => $patterns_path.'color-7.png'),
						'color-8' => array('alt' => 'Color 8', 'img' => $patterns_path.'color-8.png'),
					),
				'default' => 'color-1'
				),	
	...
	$sections[] = array(
		...
		'fields'  => array(
			...
			array(
                'id'=>'top_text',
                'type' => 'text',
                'title' => __('Text on the top(names)', 'redux-framework-demo'), 
                'default' => 'Daniel & Alex'
				),
			...
			array(
                'id'=>'middle_text',
                'type' => 'text',
                'title' => __('Text under the names', 'redux-framework-demo'), 
                'default' => 'Wedding vow'
				),
			...
			array(
				...
				'desc'=> __('Upload image used as background in header.', 'redux-framework-demo'),
				'default'=>array('url'=>get_template_directory_uri().'/img/header.jpg'),
				),
	...
	$sections[] = array(
		...
		'fields' => array(
			...
			array(
				'id'=>'header-circle-font',
				'type' => 'typography',
				'title' => __('Header and footer circle Font', 'redux-framework-demo'),
				'subtitle' => __('Select header and footer circle font.', 'redux-framework-demo'),
				'google'=>true, 
				'units'=>'px', // Defaults to px
				'default'=> array(
	...
	$sections[] = array(
		...
		'desc' => __('<p class="description">Adjust options for footer</p>', 'redux-framework-demo'),
		'fields' => array(
			array(
                'id'=>'copyright_text',
                'type' => 'text',
			...
			array(
                'id'=>'footer_top_text',
                'type' => 'text',
                'title' => __('Footer circle top text', 'redux-framework-demo'), 
                'default' => 'Daniel & Alex'
				),
			array(
                'id'=>'footer_bottom_text',
                'type' => 'text',
                'title' => __('Footer circle bottom text', 'redux-framework-demo'), 
                'default' => 'Wedding vow'
				),
